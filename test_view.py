...
from models import Conta, Historico, Bancos, Status, Tipos, engine
from view import criar_conta, listar_contas, desativar_conta, transferir_saldo, movimentar_dinheiro, total_contas
